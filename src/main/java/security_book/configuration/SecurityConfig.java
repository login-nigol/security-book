...
//Настройка stateless сессий для работы с JWT (означает конфигурацию приложения таким образом, чтобы оно не хранило
//состояние сессии на сервере, а вместо этого использовало JWT для аутентификации и авторизации пользователей)
